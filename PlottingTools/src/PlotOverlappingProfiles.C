...
#include <algorithm>
#include <typeinfo>
#include "../interface/PlotOverlappingProfiles.h"
#include"../interface/CreateCanvas.h"


void PlotOverlappingProfiles:: DrawHistograms(std::vector<FileInfo> fobjVec, std::vector<HistoInfo> hobjVec){
  CreateCanvas CC;
  TLegend* leg;
